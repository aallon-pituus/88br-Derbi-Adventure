import random
input("jos rakennat ittelles 88br derbin ja kohdistat keulan suoraan keulakulmille peli - paina enter aloittaaksesi")
...
inval5 = input("a: mvt dd b: vakio sähköt")
if inval == a: dql = 0
if inval == a: mon = 10
if inval == b: dql = 1
if inval == b: mon = 3
...
if inval3 == a: d2 = -1
if inval3 == b: d1 = 1
ranval = (random.randint(0.12))
ranval = int(ranval)
derb = ranval + dql + d1 + d2
